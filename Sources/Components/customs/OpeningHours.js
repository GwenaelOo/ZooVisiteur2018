            ...
            <LinearGradient colors={['#4c669f', '#016e8d']} style={this.getStyle().itemData}>
                <View style={this.getStyle().vignette}>
                    <View style={this.getStyle().hours}>
                        <Text style={material.headlineWhite}>9H30</Text>
                        <Text style={material.subheadingWhite}>Ouverture</Text>
                    </View>
                    <View style={this.getStyle().hours}>
                        <Text style={material.headlineWhite}>17h30</Text>
                        <Text style={material.subheadingWhite}>Fermeture</Text>
                    </View>
                </View>
            </LinearGradient>
        )
